...
default_args = {
    ...
    'email':['vaibhav.singh@students.mq.edu.au'], # who to email if fails i.e me :)
...
dag = DAG(
    ...
    schedule_interval='*/1 * * * *', # define how often you want it to run - you can pass cron expressions here
